...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> queryGropByGid(@PathVariable("gid")Long gid){
        List<AttrEntity> attrGroup = this.attrService.list(new QueryWrapper<AttrEntity>().eq("group_id", gid));
