...
public class OssController {
    ...
    public ResponseVo<Object> policy(){
        String accessId = "LTAI4GDpdQJRuLWXnStNsWV4"; // 请填写您的AccessKeyId。
        String accessKey = "z5TletiaP9KCBjObupwpriQT35R8Tr"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "c-gmall"; // 请填写您的 bucketname 。
