...
public class UserController {
    ...
    public ResponseVo<Boolean> check(@PathVariable("data")String data,@PathVariable("type")Integer type){
        ...
        Boolean result = this.userService.check(data,type);
        return ResponseVo.ok(result);
    }

    @GetMapping("query")
    public ResponseVo<UserEntity> queryUser(@RequestParam("username")String username,@RequestParam("password")String password){
