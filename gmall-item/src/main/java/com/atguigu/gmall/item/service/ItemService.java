...
public class ItemService {
    ...
    public ItemVo queryItemBySkuId(Long skuId) {
        ...
        CompletableFuture.allOf(cateCompletableFuture,brandCompletableFuture,spuCompletableFuture,imageCompletableFuture,salesCompletableFuture,
                storeCompletableFuture,saleAttrCompletableFuture,saleCompletableFuture,skuJsonCompletableFuture, descCompletableFuture,groupCompletableFuture).join();
